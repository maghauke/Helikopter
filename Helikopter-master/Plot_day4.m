...
%% Task 4.6 Noise HAR DISSE ALLEREDE I EKSISTERENDE EPS FILER
...
grid on
X1 = values_day4.time;
Y1 = values_day4.signals.values(:,4);
Y2 = values_day4.signals.values(:,5);
Y3 = values_day4.signals.values(:,6);
...
hold on
grid on
Y4 = values_day4.signals.values(:,7);
Y5 = values_day4.signals.values(:,8);
Y6 = values_day4.signals.values(:,9);
